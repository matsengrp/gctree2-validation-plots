...
def main(
    ...
    example_abundances = {
        n.sequence: n.abundance for n in example_forest_tree.tree.traverse()
    }
    ...
    for kwargs, opt_func, dag, extra_name in kwargls:
        ...
        data = [
            [ctree.compare(otree, method="RF"), ctree.compare(otree, method="MRCA")]
            for otree in trimmed_forest
        ]
